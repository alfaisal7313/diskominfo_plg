  <div class="content-wrapper">
    <div class="content row">
      <div class="box">
        ...
        <!-- /.box-header -->
        <div class="box-body">
          <a href="<?php echo base_url('admin/slideshow/upload_slide'); ?>"><button type="button" class="btn btn-primary pull-right "><i class="fa fa-file-image-o">&nbsp;</i> Tambah Slideshow</button></a>
  ...
  <script type="text/javascript">
   ...
   $(document).ready(function() {
       ...
       table = $('#mytable').DataTable({
           ...
           "ajax": {
             "url": '<?php echo site_url('admin/slideshow/json_slide'); ?>',
             "type": "POST"
           },
